...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5391168,
    DYNAMIC_BASE = 5391168,
    DYNAMICTOP_PTR = 148256;
...
// {{PRE_LIBRARY}}
  ...
  var ___tm_timezone=(stringToUTF8("GMT", 148160, 4), 148160);function _gmtime_r(time, tmPtr) {
...
var _emscripten_bind_Ruby_Execute_1 = Module["_emscripten_bind_Ruby_Execute_1"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_emscripten_bind_Ruby_Execute_1"].apply(null, arguments)
};

var _emscripten_bind_Ruby_Ruby_0 = Module["_emscripten_bind_Ruby_Ruby_0"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_emscripten_bind_Ruby_Ruby_0"].apply(null, arguments)
};

var _emscripten_bind_Ruby___destroy___0 = Module["_emscripten_bind_Ruby___destroy___0"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_emscripten_bind_Ruby___destroy___0"].apply(null, arguments)
};
...
// Ruby
/** @suppress {undefinedVars, duplicate} */function Ruby() {
  this.ptr = _emscripten_bind_Ruby_Ruby_0();
  getCache(Ruby)[this.ptr] = this;
};;
Ruby.prototype = Object.create(WrapperObject.prototype);
Ruby.prototype.constructor = Ruby;
Ruby.prototype.__class__ = Ruby;
Ruby.__cache__ = {};
Module['Ruby'] = Ruby;

Ruby.prototype['Execute'] = Ruby.prototype.Execute = /** @suppress {undefinedVars, duplicate} */function(code) {
  var self = this.ptr;
  ensureCache.prepare();
  if (code && typeof code === 'object') code = code.ptr;
  else code = ensureString(code);
  _emscripten_bind_Ruby_Execute_1(self, code);
};;

  Ruby.prototype['__destroy__'] = Ruby.prototype.__destroy__ = /** @suppress {undefinedVars, duplicate} */function() {
  var self = this.ptr;
  _emscripten_bind_Ruby___destroy___0(self);
};
(function() {
  function setupEnums() {
